...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onKrakenCleanupStarted: (callback) =>
    ipcRenderer.on("kraken-cleanup-started", (event) => callback()),
  onKrakenCleanupCompleted: (callback) =>
    ipcRenderer.on("kraken-cleanup-completed", (event) => callback()),
  onShowLoader: (callback) => 
    ipcRenderer.on("show-loader", (event) => callback()),
  onHideLoader: (callback) => 
    ipcRenderer.on("hide-loader", (event) => callback()),
  onScanStarted: (callback) => 
    ipcRenderer.on("scan-started", (event) => callback()),
  onScanStopped: (callback) => 
    ipcRenderer.on("scan-stopped", (event) => callback()),
  onScanError: (callback) => 
    ipcRenderer.on("scan-error", (event, error) => callback(error)),
  onScanRefreshed: (callback) => 
    ipcRenderer.on("scan-refreshed", (event) => callback()),
  ...
  krakenCalibrationStart: () => 
    ipcRenderer.invoke("kraken-calibration-start"),
  krakenCalibrationGetStatus: () => 
    ipcRenderer.invoke("kraken-calibration-get-status"),
  krakenCalibrationGoBack: () => 
    ipcRenderer.send("kraken-calibration-go-back"),
  krakenCalibrationCleanup: () => 
    ipcRenderer.send("kraken-calibration-cleanup"),

  // Kraken calibration event listeners
  onShowPageLoader: (callback) => 
    ipcRenderer.on("show-page-loader", (event) => callback()),
  onHidePageLoader: (callback) => 
    ipcRenderer.on("hide-page-loader", (event) => callback()),
  ...
  onAllDevicesReady: (callback) => 
    ipcRenderer.on("all-devices-ready", (event) => callback()),
  ...
  onCalibrationStarted: (callback) => 
    ipcRenderer.on("calibration-started", (event) => callback()),
});
